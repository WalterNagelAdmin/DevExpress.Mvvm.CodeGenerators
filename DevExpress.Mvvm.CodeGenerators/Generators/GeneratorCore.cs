...
{
    internal static class ViewModelGeneratorCore
    {
        public static void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (ClassDeclarationSyntax classSyntax in receiver.ClassSyntaxes)
            {
                ...
                if (hasDxAttribute)
                    mvvmCount++;
                if (hasPrismAttribute)
                    mvvmCount++;
                if (hasMvvmLightAttribute)
                    mvvmCount++;
        ...
        private static void AddAttributeFile(GeneratorExecutionContext context, SupportedMvvm mvvm, ref Compilation compilation)
        {
        ...
        [Conditional("DEBUG")]
        private static void EndExecute(TraceInfo info, int generatedCount)
        {
        ...
        [Conditional("DEBUG")]
        private static void StartExecute(ref TraceInfo info)
        {
