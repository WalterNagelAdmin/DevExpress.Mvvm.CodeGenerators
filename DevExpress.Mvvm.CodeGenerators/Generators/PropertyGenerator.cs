...
namespace DevExpress.Mvvm.CodeGenerators
{
    internal static class PropertyGenerator
    {
        ...
        private static void AppendRaiseChangedMethod(SourceBuilder source, ChangeEventRaiseMode? eventRaiseMode, string propertyName)
        {
        ...
        private static void AppendRaiseChangingMethod(SourceBuilder source, ChangeEventRaiseMode? eventRaiseMode, string propertyName)
        {
            if (eventRaiseMode == ChangeEventRaiseMode.EventArgs)
        ...
        private static void AppendSetterAttribute(SourceBuilder source, ContextInfo info, IFieldSymbol fieldSymbol, string fieldName)
        {
